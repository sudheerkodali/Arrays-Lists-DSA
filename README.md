...
*Suppose if we have taken memory alocated with 8-gb is the data base server then it actually it depends on how many datatypes we have taken , here I initiated with [10,14,18,22,26,30,34] each space occupy with 4 bits in the below image [0,1,2,3,4,5]=>[10,14,18,22,26,30,34] *
